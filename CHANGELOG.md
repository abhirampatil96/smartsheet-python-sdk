...
- Added `DataClassificationSettings`, `ClassificationLabel`, `DowngradeApprovalSettings`, `ApproverEntry`, and `LabelApproverEntry` models.
- Added `DowngradeApprovalMode` and `ApproverType` enums.
